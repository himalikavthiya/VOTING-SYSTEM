      ...
      return (
        <div>
          ...
          <div className="innerfield">
            ...
            />
            {errors.ElectionName && <p className="error">{errors.ElectionName.message}</p>}
          </div>
          <div className="innerfield">
            ...
            <input
              ...
              {...register('RegisterDate', { required: 'Election Date is required' })}
            />
            {errors.RegisterDate && <p className="error">{errors.RegisterDate.message}</p>}
          </div>
          <div className="innerfield">
            <button type="submit" className="AddData">Submit</button>
          </div>
        </form>
        </div>
